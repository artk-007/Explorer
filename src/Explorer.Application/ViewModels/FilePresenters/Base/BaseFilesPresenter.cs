...
namespace ExplorER.FilePresenters.Base
{
    public abstract class BaseFilesPresenter : BaseViewModel, IFilesPresenter
    {
        ...
        public DelegateCommand OpenNewWindowCommand => ExplorerEr.Instance.OpenNewWindowCommand;
        ...
        {
            if (CurrentDirectoryPathName == ExplorerEr.RootName)
            {
                var group = "Папки";
